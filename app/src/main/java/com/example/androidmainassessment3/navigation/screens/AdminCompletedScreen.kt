...
@Composable
fun AdminCompletedScreen(navController: NavHostController, imageViewModel: ProfileViewModel,orderViewModel: OrderViewModel){
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            CustomButton(clickEvent = {
                                orderViewModel.declinedUpdateOrder(order.orderId)
                                Toast.makeText(context, "Updated Successfully", Toast.LENGTH_SHORT)
                                    .show()
                            }, Modifier.fillMaxWidth().padding(5.dp).weight(1f), text = "Decline")
                            CustomButton(clickEvent = {
                                orderViewModel.updateOrder(order.orderId)
                                Toast.makeText(context, "Updated Successfully", Toast.LENGTH_SHORT)
                                    .show()
                            }, Modifier.fillMaxWidth().padding(5.dp).weight(1f), text = "Accept")
...
//                    Text("User ID: ${order.userId}")
//                    Text("Date: ${order.date}", color = Color.Gray, fontSize = 12.sp)
//
